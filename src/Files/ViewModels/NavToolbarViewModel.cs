...
namespace Files.ViewModels
{
    public class NavToolbarViewModel : ObservableObject, INavigationToolbar, IDisposable
    {
        ...
        public bool IsInfFile          => SelectedItems is not null && SelectedItems.Any() && SelectedItems.First().PrimaryItemAttribute == StorageItemTypes.File && new[] { ".inf", }.Contains(SelectedItems.First().FileExtension, StringComparer.OrdinalIgnoreCase);
